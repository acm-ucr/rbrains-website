...
const Club = () => {
  return (
    <div className="flex h-screen w-screen flex-col px-40 py-5">
      <h1 className="self-start p-8 text-3xl font-bold">Club</h1>
      <p className="h-full w-full rounded-2xl border-5 border-[#B64D4C] p-8 text-center">
